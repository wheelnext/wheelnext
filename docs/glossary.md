...
| Cross-compilation | Compiling _on_ a given platform _for_  another platform | See [here](https://pypackaging-native.github.io/background/compilation_concepts/#cross-compilation) |
