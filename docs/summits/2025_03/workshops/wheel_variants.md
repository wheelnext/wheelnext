...
fragmenting the Python ecosystem. As well this proposal also focuses on how to minimize the maintenance impact towards
`pip` maintainers while attempting to enabling the most flexible ecosystem possible.
